...
This project is indexed by GitNexus as **ragweld** (18443 symbols, 39144 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
