...
const OUT_DIR = '/Users/davidmontgomery/ragweld/tmp/ui_acceptance_20260228';
...
async function main() {
  ...
  try {
    ...
    const maxSourceChunks = await setNumeric('Max source chunks', 300);
    const maxPairs = await setNumeric('Max pairs', 200);
    const pairsPerSource = await setNumeric('Pairs per source', 2);
