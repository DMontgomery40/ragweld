...
async def test_get_all_models(client: AsyncClient):
    """Verify /api/models returns all models."""
...
@pytest.mark.asyncio
async def test_models_have_required_fields(client: AsyncClient):
...
@pytest.mark.asyncio
async def test_get_embedding_models(client: AsyncClient):
...
@pytest.mark.asyncio
async def test_get_generation_models(client: AsyncClient):
...
@pytest.mark.asyncio
async def test_get_reranker_models(client: AsyncClient):
...
@pytest.mark.asyncio
async def test_invalid_component_type(client: AsyncClient):
...
@pytest.mark.asyncio
async def test_case_insensitive_component_type(client: AsyncClient):
