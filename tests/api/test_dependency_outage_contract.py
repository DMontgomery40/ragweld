...
REQUESTS = [
    ...
    ("POST", "/api/synthetic/run/start", {"corpus_id": "missing", "provider": "grounded_qa", "recipe": "eval_dataset", "generator_model": "litellm:openai.gpt-6-luna", "judge_model": "litellm:openai.gpt-6-luna"}),
