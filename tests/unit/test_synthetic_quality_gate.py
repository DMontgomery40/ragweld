...
from server.synthetic.recipes import synthetic_model_category


def test_synthetic_model_category_accepts_expected_prefixes() -> None:
    assert synthetic_model_category("openai/gpt-4o-mini") == "openai"
    assert synthetic_model_category("openrouter:openai/gpt-4o-mini") == "openrouter"
    assert synthetic_model_category("local:qwen3-coder:14b") == "local"
    assert synthetic_model_category("ragweld:mlx-community/Qwen3-1.7B-4bit") == "ragweld"
